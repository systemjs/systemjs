...
// adds a link to the error message documentation on an error
function errMsgWithLink(msg) {
  return msg + '\n(https://github.com/systemjs/systemjs/blob/' + this.version.split(' ')[0] + '/docs/faqs.md#' + msg.toLowerCase().replace(/ /g, '-').replace(/\./, '') + ')';
}
