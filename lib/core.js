...
// ensure baseURL and paths are normalized
function preparePaths() {
  ...
  for (var p in this.paths) {
    if (this.paths[p] !== this._loader.paths[p])
      this.paths[p] = this._loader.paths[p] = urlResolve(this.paths[p], isRel(this.paths[p]) ? baseURI : this.baseURL);
  }
}
...
function coreResolve(name, parentName) {
  ...
  preparePaths.call(this);
  return applyPaths(this.paths, name) || this.baseURL + name;
}
