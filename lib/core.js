...
hookConstructor(function(constructor) {
  return function() {
    ...
    // module loader sets baseURL to baseURI by default in constructor
...
/*
  ...
  If a name is URL-like, we apply URL normalization (/ or ./)
...
hook('normalize', function() {
  return function(name, parentName) {
    ...
    if (name[0] == '.' || name[0] == '/')
      return new URL(name, parentName || getBaseURLObj.call(this)).href;
    return name;
  };
});
