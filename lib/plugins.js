  ...
  hook('fetch', function(fetch) {
    return function(load) {
      ...
      if (load.metadata.loaderModule && load.metadata.format != 'defined') {
        if (load.metadata.loaderModule.load)
          return '';
  ...
  hook('instantiate', function(instantiate) {
    return function(load) {
      ...
      if (load.metadata.loaderModule && !loader.builder && load.metadata.format != 'defined') {
        ...
        else if (load.metadata.loaderModule.load)
          return Promise.resolve(load.metadata.loaderModule.load.call(loader, load.address, load.name))
          .then(function (result) {
            if (result !== undefined)
              createInstantiate(load, result);
            return instantiate.call(loader, load);
