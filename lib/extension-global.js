...
function global(loader) {
  ...
  var globalHelpers = loader.newModule({
  ...
  loader.set('@@global-helpers', globalHelpers);
  ...
  loader.instantiate = function(load) {
    ...
    if (load.metadata.format == 'global') {
      load.metadata.execute = function(require, exports, module) {
        ...
        globalHelpers.prepareGlobal(module.id, load.metadata.deps);
        ...
        return globalHelpers.retrieveGlobal(module.id, exportName, load.metadata.init);
      }
    }
