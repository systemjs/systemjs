    ...
    return function(load) {
      ...
      if (load.metadata.format == 'amd' || !load.metadata.format && load.source.match(amdRegEx)) {
        ...
        if (load.metadata.globals) {
          var globals = {};
          for (var g in load.metadata.globals) (function(g) {
            globalsPromises.push(loader['import'](load.metadata.globals[g], load.name).then(function(globalValue) {
              globals[g] = globalValue;
            }));
          })(g);
        }
