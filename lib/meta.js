...
(function() {
  ...
  SystemJSLoader.prototype.meta = function(metadata) {
    for (var module in metadata) {
      var meta = metadata[module];
      // normalize relative URL module specifiers to baseURL
      if (module[0] == '/' || module[0] == '.')
        module = new URL(module, getAbsBaseURL.call(this)).href;
      this.metadata[module] = meta;
    }
  };
