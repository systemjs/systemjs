...
function es6(loader) {
  ...
  loader.translate = function(load) {
    ...
    .then(function(source) {
      ...
      // detect ES6
        ...
        if (autoloadTranspiler && !loader.global[transpiler])
      ...
      if (autoloadTranspiler && !loader.global[transpilerRuntimeGlobal] && source.indexOf(transpilerRuntimeGlobal) != -1) {
  ...
  loader.instantiate = function(load) {
    var loader = this;
    if (autoloadTranspiler && (load.name == transpilerModule || load.name == transpilerRuntimeModule)) {
      loader.__exec(load);
      return {
        deps: [],
        execute: function() {
