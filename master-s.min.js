!(function () {
  ...
  if (!r && "undefined" != typeof location) {
    const e = (r = location.href.split("#")[0].split("?")[0]).lastIndexOf("/");
    -1 !== e && (r = r.slice(0, e + 1));
  }
  const o = /\\/g;
  function i(e, t) {
    if (
      (-1 !== e.indexOf("\\") && (e = e.replace(o, "/")),
      "/" === e[0] && "/" === e[1])
    )
    ...
    if (
      ...
      const o = r.slice(0, r.lastIndexOf("/") + 1) + e,
        i = [];
      let c = -1;
      ...
      return (
        ...
        t.slice(0, t.length - r.length) + i.join("")
      );
    }
  }
  const c = "undefined" != typeof Symbol,
    s = c && Symbol.toStringTag,
    l = c ? Symbol() : "@";
  function u() {
    this[l] = {};
  }
  const f = u.prototype;
  let d;
  (f.prepareImport = function () {}),
    (f.import = function (e, t) {
      const n = this;
        ...
        .then(function (e) {
          const t = (function e(t, n, r) {
            ...
            let u = Promise.resolve()
              ...
              .then(function (e) {
                if (!e) throw Error("Module " + n + " did not instantiate");
                const r = e[1](
                  function (e, t) {
                    o.h = !0;
                    let n = !1;
                    if ("object" != typeof e)
                      ...
                      for (let t in e) {
                        let r = e[t];
                        (t in c && c[t] === r) || ((c[t] = r), (n = !0));
                      }
                      e.__esModule && (c.__esModule = e.__esModule);
                    }
                    if (n) for (let e = 0; e < i.length; e++) i[e](c);
                    return t;
                  },
                  2 === e[1].length
                    ? {
            ...
            const f = u.then(function (r) {
              return Promise.all(
                r[0].map(function (o, i) {
                  const c = r[1][i];
                  return Promise.resolve(t.resolve(o, n)).then(function (r) {
                    const o = e(t, r, n);
  ...
  const a = Object.freeze(Object.create(null));
  n.System = new u();
  const h = f.register;
  let p, m;
  function g() {
  ...
  (f.register = function (e, t) {
    ...
    t &&
      window.addEventListener("error", function (e) {
        (p = e.filename), (m = e.error);
      }),
    (f.instantiate = function (e, t) {
      const n = this;
      return new Promise(function (r, o) {
        const i = f.createScript(e);
        i.addEventListener("error", function () {
          o(Error("Error loading " + e + (t ? " from " + t : "")));
        }),
          i.addEventListener("load", function () {
            document.head.removeChild(i), p === e ? o(m) : r(n.getRegister());
          }),
          document.head.appendChild(i);
      });
    }),
    t && (window.addEventListener("DOMContentLoaded", g), g()),
    e &&
      "function" == typeof importScripts &&
      (f.instantiate = function (e) {
        const t = this;
    ...
    (f.resolve = function (e, t) {
      ...
      if (!n) {
        ...
        throw Error('Cannot resolve "' + e + (t ? '" from ' + t : '"'));
      }
