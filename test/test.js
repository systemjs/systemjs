...
asyncTest('Object.prototype.toString(new Module())== "[object Module]"', function () {
...
asyncTest('Importing a script with right integrity passes', function () {
  System.config({
    meta: {
  ...
  System.import('tests/csp/integrity-1.js').then(function (m) {
...
asyncTest('Importing a script with wrong integrity fails', function () {
  ...
  System.import('tests/csp/integrity-2.js').then(function (m) {
    ok(false);
    start();
  }, function (e) {
