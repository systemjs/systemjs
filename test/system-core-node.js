...
describe('Core API - Node.js', function () {
  ...
  describe('Registry API - Node.js', function () {
...
describe('Loading Cases - Node.js', function() {
  ...
  //   vm.runInThisContext(`${source}//# sourceURL=${path}`);
  //   return this.getRegister();
  // };

  describe('Simple tests - Node.js', function() {
  ...
  describe('Circular dependencies - Node.js', function() {
  ...
  describe('Loading order - Node.js', function() {
  ...
  describe('Top-level await - Node.js', function () {
  ...
  describe('Export variations - Node.js', function () {
  ...
  describe('Errors - Node.js', function () {
    ...
    it('should throw if on syntax error', async function () {
      loader.resolve = (id, parentUrl) => resolveIfNotPlainOrUrl(id, parentUrl || testUrl.href);
    ...
    it('missing file error', async function () {
      const err = await getImportError('./register-modules/load-non-existent.js');

      const importUrl = new URL('./register-modules/non-existent.js', testUrl);
      const parentUrl = new URL('./register-modules/load-non-existent.js', testUrl);

      assert.equal(err, `Error: Error loading ${importUrl} from ${parentUrl}`);
    });
  });
});
