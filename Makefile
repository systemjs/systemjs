...
SystemJS = meta register core global cjs amd map plugins hash bundles depCache
SystemCSP = scriptLoader meta register core global cjs amd map plugins hash bundles depCache
