...
!(function () {
  ...
  function u(t, e, n, r, o) {
    for (let c in t) {
      ...
      const l = d(r, i(u, n) || u, o);
      l ? (e[s] = l) : a(c, u, "bare specifier did not resolve");
    }
  }
  function l(t, e) {
    if (e[t]) return t;
  ...
  function f(t, e) {
    ...
    if (n) {
      const r = e[n];
      if (null === r) return;
      if (!(t.length > n.length && "/" !== r[r.length - 1]))
        return r + t.slice(n.length);
      a(n, r, "should have a trailing '/'");
    }
  }
  function a(t, e, n) {
    console.warn(
      "Package target " + n + ", resolving target '" + e + "' for " + t
    );
  }
  function d(t, e, n) {
  ...
  const h = "undefined" != typeof Symbol,
    p = h && Symbol.toStringTag,
    m = h ? Symbol() : "@";
  function y() {
    this[m] = {};
  }
  ...
  function b(t, e, n) {
    if ((t.onload(n, e.id, e.d && e.d.map(v)), n)) throw n;
  }
  let x;
  (g.prepareImport = function () {}),
    (g.import = function (t, e) {
      const n = this;
      return Promise.resolve(n.prepareImport())
        ...
        .then(function (t) {
          const e = (function t(e, n, r) {
            ...
            p && Object.defineProperty(c, p, { value: "Module" });
              ...
              .then(function (t) {
                ...
                const r = t[1](
                  function (t, e) {
                    ...
                    let n = !1;
                    if ("object" != typeof t)
                      (t in c && c[t] === e) || ((c[t] = e), (n = !0));
                    else {
                      for (let e in t) {
                        let r = t[e];
                        (e in c && c[e] === r) || ((c[e] = r), (n = !0));
                      }
                      t.__esModule && (c.__esModule = t.__esModule);
                    }
                    if (n) for (let t = 0; t < i.length; t++) i[t](c);
                    return e;
                  },
                  2 === t[1].length
                    ? {
                ...
                return (
                  (o.e = r.execute || function () {}), [t[0], r.setters || []]
                );
              });
    ...
    (g.onload = function () {}),
    (g.register = function (t, e) {
      x = [t, e];
    }),
    (g.getRegister = function () {
      const t = x;
      return (x = void 0), t;
    });
  const S = Object.freeze(Object.create(null));
  n.System = new y();
  let E,
    O = { imports: {}, scopes: {} };
  e &&
              ...
              function (t) {
                E = E.then(function () {
                  return (
                    ...
                    Promise.resolve(JSON.parse(t.innerHTML))
                  ).then(function (e) {
                    O = (function (t, e, n) {
                      const r = {
                        imports: s({}, n.imports),
                      ...
                      if (
                        (t.imports && u(t.imports, r.imports, e, n, null),
                        t.scopes)
                      )
    ...
    (g.resolve = function (t, e) {
      return (
        ...
        (function (t, e) {
          throw Error(
            "Unable to resolve specifier '" + t + (e ? "' from " + e : "'")
          );
        })(t, e)
      );
    });
  ...
  function A() {
    Array.prototype.forEach.call(
      ...
      function (t) {
        t.src &&
          System.import(
            "import:" === t.src.slice(0, 7) ? t.src.slice(7) : c(t.src, r)
          );
      }
    );
  }
  (g.register = function (t, e) {
    ...
    e &&
      window.addEventListener("error", function (t) {
        (j = t.filename), (P = t.error);
      }),
    (g.instantiate = function (t, e) {
      const n = this;
      return new Promise(function (r, o) {
        const i = g.createScript(t);
        i.addEventListener("error", function () {
          o(Error("Error loading " + t + (e ? " from " + e : "")));
        }),
          i.addEventListener("load", function () {
            document.head.removeChild(i), j === t ? o(P) : r(n.getRegister());
          }),
          document.head.appendChild(i);
      });
    }),
    e && (window.addEventListener("DOMContentLoaded", A), A()),
    t &&
      "function" == typeof importScripts &&
      (g.instantiate = function (t) {
        const e = this;
          ...
          for (let i in t)
            if (
              !(
                !t.hasOwnProperty(i) ||
                (!isNaN(i) && i < t.length) ||
                (n && t[i] && t[i].parent === window)
              )
            ) {
              if ((0 === c && i !== r) || (1 === c && i !== o)) return i;
              c++, (e = i);
            }
          if (e !== i) return e;
        })();
                  ...
                  return (WebAssembly.compileStreaming
                    ...
                    return (
                      WebAssembly.Module.imports &&
                        WebAssembly.Module.imports(t).forEach(function (t) {
                          const o = t.module;
                          -1 === e.indexOf(o) &&
                            (e.push(o),
                            n.push(function (t) {
                      ...
                      [
                        ...
                        function (e) {
                          return {
                            setters: n,
                            execute: function () {
                              return WebAssembly.instantiate(t, r).then(
                                function (t) {
                                  e(t.exports);
                                }
                              );
  ...
  const I = "undefined" != typeof Symbol && Symbol.toStringTag;
  (g.get = function (t) {
    const e = this[m][t];
    ...
    (g.set = function (t, e) {
      ...
      I && "Module" === e[I]
        ? (n = e)
        : ((n = Object.assign(Object.create(null), e)),
          I && Object.defineProperty(n, I, { value: "Module" }));
      ...
      return (
        !o.e &&
        !o.E &&
        (Object.assign(o, { n: n, I: void 0, L: void 0, C: r }), n)
      );
    }),
    (g.has = function (t) {
      return !!this[m][t];
  ...
  const C = "undefined" != typeof Symbol && Symbol.iterator;
  g.entries = function () {
    const t = this,
      e = Object.keys(t[m]);
    let n,
    ...
    const i = {
      next: function () {
        ...
        return { done: void 0 === r, value: void 0 !== r && [r, n] };
      },
    };
    return (
      (i[C] = function () {
