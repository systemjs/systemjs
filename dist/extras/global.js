...
this.systemjs.extras.global.js = (function () {
	 ...
	 */
	const systemJSPrototype = System.constructor.prototype; // safari unpredictably lists some new globals first or second in object order
	...
	function getGlobalProp() {
	  ...
	  for (let p in commonjsGlobal) {
	    if (!commonjsGlobal.hasOwnProperty(p)) continue;
