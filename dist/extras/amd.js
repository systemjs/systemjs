...
this.systemjs.extras.amd.js = (function () {
	...
	const systemRegister = systemPrototype.register; // if we have named register support continue to use it
	...
	commonjsGlobal.define = function (name, deps, execute) {
	  // define('', [], function () {})
